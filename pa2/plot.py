...
if __name__ == '__main__':
    ...
    fig = plot.get_figure()
    fig.savefig('p1plot_cor_cmt.png')
    ...
    plot = sns.pointplot('prob', 'ave_cmt', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    fig.savefig('p1plot_drop_cmt.png')
    ...
    fig = plot.get_figure()
    fig.savefig('p1plot_drop_rtt.png')
    ...
    plot = sns.pointplot('prob', 'rtt', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    fig.savefig('p1plot_cor_rtt.png')
    ...
    fig = plot.get_figure()
    fig.savefig('p1plot_drop_retrans.png')
    ...
    plot = sns.pointplot('prob', 'retrans', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    fig.savefig('p1plot_cor_retrans.png')
