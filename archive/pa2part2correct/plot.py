...
if __name__ == '__main__':
    ...
    data = data.iloc[:, :2]
    print("GBN corruption vs communication time")
    ...
    data = data.iloc[:, :2]
    print("GBN loss vs communication time")
    cout_conf_interval(data,col=0)
    plot = sns.pointplot('prob', 'ave_cmt', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    ...
    data = pd.read_csv('drop_exp', names=namelist)
    data = data.iloc[:, [1,4]]
    print("GBN loss vs num retransmission")
    cout_conf_interval(data)
    ...
    data = pd.read_csv('corrupt_exp', names=namelist)
    data = data.iloc[:, [1,4]]
    print("GBN corrupt vs num retransmission")
    cout_conf_interval(data)
    plot = sns.pointplot('prob', 'retrans', data=data, dodge=True, join=True)
    fig = plot.get_figure()
   ...
   ## Tput 
    ...
    data = pd.read_csv('drop_exp', names=namelist)
    data = data.iloc[:, [1,5]]
    print("GBN loss vs tput")
    cout_conf_interval(data)
    plot = sns.pointplot('prob', 'tput', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    fig.savefig('../plots/p2plot_drop_tput.png')

    fig.clf()

    data = pd.read_csv('corrupt_exp', names=namelist)
    data = data.iloc[:, [1,5]]
    print("GBN corrupt vs tput")
    cout_conf_interval(data)
    plot = sns.pointplot('prob', 'tput', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    fig.savefig('../plots/p2plot_cor_tput.png')
    ...
    data = pd.read_csv('drop_exp', names=namelist)
    data = data.iloc[:, [1,6]]
    print("GBN loss vs gput")
    cout_conf_interval(data)
    plot = sns.pointplot('prob', 'gput', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    fig.savefig('../plots/p2plot_drop_gput.png')

    fig.clf()

    data = pd.read_csv('corrupt_exp', names=namelist)
    data = data.iloc[:, [1,6]]
    print("GBN corrupt vs gput")
    cout_conf_interval(data)
    plot = sns.pointplot('prob', 'gput', data=data, dodge=True, join=True)
    fig = plot.get_figure()
    fig.savefig('../plots/p2plot_cor_gput.png')
